...
image::https://github.com/Arquisoft/dechat_en2b/blob/master/adocs/images/businessContext-2.png[Business context diagram]
...
image:https://github.com/Arquisoft/dechat_en2b/blob/master/adocs/images/technical_diagram.png[Technical context diagram]
